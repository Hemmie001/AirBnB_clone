...
class BaseModel:
    ...
    def __str__(self):
        """
        This is a python method called when we use print/str.to convert object into a string.
        here it Return the print/str representation of the BaseModel instance
        """
    ...
    def save(self):
        """
        This Public instance methods, updates the public instance attribute(updated_at)
    ...
    def to_dict(self):
        """
        This public instance methods updates and returns a returns a dictionary
        containing all keys/values of __dict__ of the instance with self.__dict__
        we are making a copy.
        This method will be the first piece of the serialization/deserialization
        prcess which creates a dictionary representation with a 
